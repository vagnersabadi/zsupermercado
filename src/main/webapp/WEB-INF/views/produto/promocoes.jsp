...
<body>
	...
	<div class="container" style="margin-top: 10px;">
		<ul class="nav nav-tabs">
			...
			<li role="presentation"><a href="listaProdutos">Todos
					Produtos</a></li>
			<li role="presentation"><a href="produtoscadastrar">Cadastro</a></li>
			<li role="presentation" class="active"><a href="#">Minhas
					promoções</a></li>
						...
						<c:forEach items="${produtos}" var="c">
							<tr>
								...
								<td><a class="btn btn-success fa fa-wrench "
									href="TirarPromocao?codigo=${c.codigo}" title="Alterar Produto">Tirar
										da promoção </a></td>
							</tr>
						</c:forEach>
	...
	<c:if test="${empty produtos}">
		<h1>
			<div class="alert alert-info">
				<strong>Info!</strong> Não há produtos em promoção
			</div>
		</h1>
	</c:if>
